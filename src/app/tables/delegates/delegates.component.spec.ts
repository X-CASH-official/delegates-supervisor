...
describe('delegatesComponent', () => {
  ...
  it('should set dash card threes property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard3').dashData.text).toBe(0));

  it('should create dash card four', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard4')).toBeTruthy());
  it('should set dash card fours title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard4').dashData.title).toBe('BLOCK VERIFIERS ONLINE TOTAL ROUNDS'));
  it('should set dash card fours property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard4').dashData.text).toBe(0));

  it('should create dash card five', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard5')).toBeTruthy());
  it('should set dash card fives title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard5').dashData.title).toBe('ONLINE STATUS'));
  ...
  it('should set dash card sixs title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard6').dashData.title).toBe('BLOCK VERIFIER ONLINE PERCENTAGE'));
  it('should set dash card sixs property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard6').dashData.text).toBe(0));

  it('should create dash card seven', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard7')).toBeTruthy());
  it('should set dash card sevens title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard7').dashData.title).toBe('BLOCK PRODUCER TOTAL ROUNDS'));
  it('should set dash card sevens property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard7').dashData.text).toBe(0));

  it('should create dash card eight', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard8')).toBeTruthy());
  it('should set dash card eights title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard8').dashData.title).toBe('TOTAL BLOCKS'));
  it('should set dash card eights property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard8').dashData.text).toBe(0));

  it('should create dash card nine', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard9')).toBeTruthy());
  it('should set dash card nines title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard9').dashData.title).toBe('AVERAGE'));
  it('should set dash card nines property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard9').dashData.text).toBe(0));

  it('should create dash card ten', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard10')).toBeTruthy());
  it('should set dash card tens title', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard10').dashData.title).toBe('ESTIMATED TIME SINCE LAST BLOCK FOUND (IN HOURS)'));
  it('should set dash card tens property to a string', () => expect(fixture.debugElement.nativeElement.querySelector('#dashcard10').dashData.text).toBe(0));
